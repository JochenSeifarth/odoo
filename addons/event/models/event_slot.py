...
class EventSlot(models.Model):
    ...
    _order = "event_id, start_datetime, end_datetime, id"
    ...
    event_date_begin = fields.Datetime(related="event_id.date_begin")
    event_date_end = fields.Datetime(related="event_id.date_end")
    ...
    def _compute_display_name(self):
        ...
        """
        for slot in self:
            name = f"{slot.start_datetime} - {slot.end_datetime}"
            if (
